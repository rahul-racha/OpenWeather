...
//        if (locationWeather.location.zipCode != "") {
        holder.view.area_textview.text =
            (holder.view.area_textview.text as String) + ", " + "22305" //locationWeather.location.zipCode
//        }
...
//                Toast.makeText(v!!.context, "Clicked on ${position}", Toast.LENGTH_LONG).show()
//            }
//        })
    }
